 ...
 */
jx.Core.prototype.getFps = function() {
  return Math.floor(this.fps);
};


/**
 * @param {string} id The key to retreive our cached object.
 * @param {number} w The width of our bitmap.
 * @param {number} h The height of our bitmap.
 * @return {Object} The canvas element.
 */
jx.Core.prototype.getCache = function(id, w, h) {
  w = w || null;
  h = h || null;
